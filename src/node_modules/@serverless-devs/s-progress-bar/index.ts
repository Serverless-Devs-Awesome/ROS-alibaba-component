...
export class ProgressService {
  ...
  constructor(protected readonly type: ProgressType, protected readonly options: ProgressBarOptions, format ?:string) {
    let opts = ProgressService.initProgressBarOptions(type, options);
    let fmt = ProgressService.initFormat(type, format);
  ...
  updateBarType(currentTransferred :number) :void {
    let increment = currentTransferred - this.bar.curr;
